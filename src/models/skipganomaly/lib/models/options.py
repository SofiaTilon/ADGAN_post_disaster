...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--residuals', default=False, help='Save pixel wise residual images')
        ...
        self.parser.add_argument('--save_test_single', action='store_true', help='save test images one by one')
        self.parser.add_argument('--save_res', action='store_true', help='save res npy files')
        self.parser.add_argument('--save_residual_img', action='store_true', help='save residual images, warning: takes long time')
        self.parser.add_argument('--anom_file_name', type=str, default="scores_test.pkl", help='name of test anom file')
        self.isTrain = True
        self.opt = None
